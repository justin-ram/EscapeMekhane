...
namespace Pinwheel.Vista.Diagnostics
{
    public class VistaDebuggerWindow : EditorWindow
    {
        ...
        private static readonly int DOTS_INSTANCE_COUNT = Shader.PropertyToID("_InstanceCount");
        ...
        private class EventTreeView : TreeViewCompat
        {
            ...
            protected override TreeViewItemCompat BuildRoot()
            {
                ...
                List<TreeViewItemCompat> rows = new List<TreeViewItemCompat>();
        ...
        private TreeViewStateCompat m_treeViewState;
        ...
        private void DrawToolbar()
        {
            ...
            else
            {
                ...
                {
                    VistaManager vistaManager = Utilities.FindAnyObjectCompat<VistaManager>();
        ...
        {
            GenerationTask task = SceneBiomeService.GenerateAll(vistaManager);
        ...
        private void LoadSession(string directory)
        {
            ...
            m_treeViewState = new TreeViewStateCompat();
        ...
        private static bool IsInstanceSampleNode(string scopeLabel)
        {
            return scopeLabel.Contains("TreeOutputNode")
                || scopeLabel.Contains("TreeSlotOutputNode")
        ...
        private RenderTexture GetOrVisualizeBuffer(DebugEvent capture, DebugBufferInterpretation bufferInterpretation)
        {
            ...
            try
            {
                ...
                dotsShader.SetInt(DOTS_INSTANCE_COUNT, instanceCount);
