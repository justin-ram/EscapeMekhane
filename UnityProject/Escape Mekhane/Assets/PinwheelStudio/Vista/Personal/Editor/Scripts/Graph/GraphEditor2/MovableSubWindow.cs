...
namespace Pinwheel.VistaEditor.Graph
{
    public class MovableSubWindow : SubWindow
    {
        ...
        private readonly bool m_persistViewData;

        public System.Action positionDragged;

        public MovableSubWindow(GraphEditorBase parentEditor, string viewKey, bool persistViewData = true) : base(parentEditor, viewKey)
        {
            m_persistViewData = persistViewData;
            viewDataKey = this.GetType().Name + viewKey;
            if (m_persistViewData)
            {
        ...
        public override void Show()
        {
            ...
            EnableWindowDragging(OnGeometryManipulated, OnPositionDragged);
        ...
        private void OnPositionDragged()
        {
    ...
    public class IMGUISubWindow : MovableSubWindow
    {
        ...
        public IMGUISubWindow(GraphEditorBase parentEditor, string viewKey, bool persistViewData = true) : base(parentEditor, viewKey, persistViewData)
        {
    ...
    {
        public const float DEFAULT_SIDE_SNAP_WIDTH = 360f;

        public NodePropertiesSubWindow(GraphEditorBase parentEditor, string viewKey) : base(parentEditor, viewKey, false) { }
    }
