...
namespace Pinwheel.VistaEditor.Graph
{
    public class SubWindowDragZone : MouseManipulator
    {
        ...
        public Action onPositionDragged;
        ...
        private void HandleSnapping(IMouseEvent e)
        {
            ...
            float sideSnapWidth = window is NodePropertiesSubWindow ?
                NodePropertiesSubWindow.DEFAULT_SIDE_SNAP_WIDTH :
                windowParentSize.y * 0.5f;
