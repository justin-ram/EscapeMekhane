        ...
        public override void OnGUI(INode node)
        {
            ...
            if (GUILayout.Button(EDIT_GRAPH, GUILayout.Width(50)))
            {
                if (n.graph != null)
                {
                    ...
                    TerrainDataGraph parentGraph = m_graphEditor.clonedGraph as TerrainDataGraph;
                    ...
                    GraphEditorBase subgraphEditor = GraphEditorBase.OpenGraph(subGraph, inputProvider);
                }
            }
