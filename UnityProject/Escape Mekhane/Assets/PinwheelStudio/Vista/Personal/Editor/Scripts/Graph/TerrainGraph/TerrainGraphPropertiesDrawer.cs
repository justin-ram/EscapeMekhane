...
namespace Pinwheel.VistaEditor.Graph
{
    public class TerrainGraphPropertiesDrawer : IGraphPropertiesDrawer
    {
        ...
        private static readonly GUIContent FILE_EXPORT_HEADER = new GUIContent("FILE EXPORT");
        ...
        private static readonly GUIContent GRAPH_EDITOR_UI_HEADER = new GUIContent("Graph Editor UI");
        ...
        public void OnDrawProperties(GraphAsset graph)
        {
            ...
            TerrainDataGraph instance = graph as TerrainDataGraph;
            ...
            EditorCommon.Header(FILE_EXPORT_HEADER);
            EditorGUI.BeginChangeCheck();
            ...
            EditorCommon.Header(GRAPH_EDITOR_UI_HEADER);
            EditorGUI.BeginChangeCheck();
