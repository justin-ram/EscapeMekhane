...
namespace Pinwheel.VistaEditor
{
    ...
    public class EditorSettings : ScriptableObject
    {
        ...
        public class GeneralSettings
        {
            ...
            [SerializeField]
            private bool m_sceneViewOverlayInitialized;
            internal bool sceneViewOverlayInitialized
            {
                get
                {
                    return m_sceneViewOverlayInitialized;
                }
                set
                {
                    m_sceneViewOverlayInitialized = value;
                }
            }
            ...
            public GeneralSettings()
            {
                ...
                m_sceneViewOverlayInitialized = false;
            }
        }
        ...
        public class TroubleshootingSettings
        {
            ...
            internal static string GetExecLogFilePath(TerrainDataGraph graph)
            {
            ...
            internal static string[] GetGraphExecLog(TerrainDataGraph graph)
            {
