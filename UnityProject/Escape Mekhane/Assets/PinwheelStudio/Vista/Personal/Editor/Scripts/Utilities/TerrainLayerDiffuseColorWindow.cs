...
namespace Pinwheel.VistaEditor
{
    public class TerrainLayerDiffuseColorWindow : EditorWindow
    {
        ...
        private bool m_interactionRecorded;
        ...
        private void OnGUI()
        {
            ...
            using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox))
            {
                ...
                if (m_colorChanged &&
                    !m_interactionRecorded &&
                    GUIUtility.hotControl == 0)
                {
                    m_interactionRecorded = true;
                    SuccessfulActionCounter.Record(
                        SuccessfulActionCounter.ActionKeys.UTIL_TOOL_INTERACTION);
                }
            }
        }
