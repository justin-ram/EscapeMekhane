...
namespace Pinwheel.Vista
{
    ...
    public class BiomeData : System.IDisposable
    {
        ...
        /// <summary>
        /// Detaches the height map and transfers ownership to the caller.
        /// </summary>
        public RenderTexture DetachHeightMap()
        {
            RenderTexture texture = heightMap;
            heightMap = null;
            return texture;
        }

        /// <summary>
        /// Detaches the hole map and transfers ownership to the caller.
        /// </summary>
        public RenderTexture DetachHoleMap()
        {
            RenderTexture texture = holeMap;
            holeMap = null;
            return texture;
        }

        /// <summary>
        /// Detaches the mesh-density map and transfers ownership to the caller.
        /// </summary>
        public RenderTexture DetachMeshDensityMap()
        {
            RenderTexture texture = meshDensityMap;
            meshDensityMap = null;
            return texture;
        }

        /// <summary>
        /// Detaches the albedo map and transfers ownership to the caller.
        /// </summary>
        public RenderTexture DetachAlbedoMap()
        {
            RenderTexture texture = albedoMap;
            albedoMap = null;
            return texture;
        }

        /// <summary>
        /// Detaches the metallic map and transfers ownership to the caller.
        /// </summary>
        public RenderTexture DetachMetallicMap()
        {
            RenderTexture texture = metallicMap;
            metallicMap = null;
            return texture;
        }
        ...
        /// <summary>
        /// Detaches all terrain-layer weight pairs and transfers texture ownership to the caller.
        /// </summary>
        public void DetachLayerWeights(List<TerrainLayer> layers, List<RenderTexture> weights)
        {
            GetLayerWeights(layers, weights);
        ...
        /// <summary>
        /// Detaches all detail-density pairs and transfers texture ownership to the caller.
        /// </summary>
        public void DetachDensityMaps(List<DetailTemplate> templates, List<RenderTexture> densityMaps)
        {
            GetDensityMaps(templates, densityMaps);
