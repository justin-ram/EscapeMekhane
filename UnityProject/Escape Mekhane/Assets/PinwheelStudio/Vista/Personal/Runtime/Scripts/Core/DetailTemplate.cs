...
namespace Pinwheel.Vista
{
    ...
    public class DetailTemplate : ScriptableObject
    {
        ...
        /// <summary>
        /// Gets or sets legacy texture variants retained for serialized compatibility.
        /// </summary>
        /// <remarks>
        /// The getter returns a copy of the stored array and returns an empty array when template variants are not
        /// supported by the current integration. Null assignments are converted to an empty array. Terrain population
        /// ignores these entries; only <see cref="texture"/> produces a grass/detail prototype.
        /// </remarks>
        ...
        /// <summary>
        /// Gets or sets legacy prefab variants retained for serialized compatibility.
        /// </summary>
        /// <remarks>
        /// The getter returns a copy of the stored array and returns an empty array when variants are unsupported by
        /// the current integration. Null assignments are converted to an empty array. Terrain population ignores these
        /// entries; only <see cref="prefab"/> produces a detail prototype.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Values below one are clamped to one. Unity Terrain applies this value to the template's single generated
        /// prototype when converting density textures into integer detail layers.
        /// </remarks>
        public int density
        {
            get
