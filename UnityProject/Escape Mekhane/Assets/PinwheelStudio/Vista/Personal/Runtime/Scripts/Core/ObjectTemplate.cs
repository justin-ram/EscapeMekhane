...
namespace Pinwheel.Vista
{
    ...
    /// Object templates are paired with <see cref="InstanceSample"/> buffers in <see cref="BiomeData"/> and consumed by
        /// terrain-system object populators. Each valid sample spawns the primary prefab, then applies sampled rotation
        /// and scale before optional alignment to the terrain normal.
    /// </remarks>
    public class ObjectTemplate : ScriptableObject
    {
        ...
        /// </summary>
        /// <remarks>
        /// This prefab is required for the template to be valid. Every generated instance uses it as the spawn source.
        /// </remarks>
        ...
        /// entries and spawns only <see cref="prefab"/>.
        /// </remarks>
