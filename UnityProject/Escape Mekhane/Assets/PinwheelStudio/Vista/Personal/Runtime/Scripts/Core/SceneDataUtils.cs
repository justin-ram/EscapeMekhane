...
namespace Pinwheel.Vista
{
    ...
    public static class SceneDataUtils
    {
        ...
        public static void CollectWorldTextureWeight(
            ITile[] tiles,
            ...
            Bounds worldBounds)
        {
            ...
            for (int i = 0; i < tiles.Length; ++i)
            {
                ...
                if (tile is ISceneTextureWeightProvider provider)
                {
                    provider.OnCollectSceneTextureWeight(terrainLayer, targetRt, worldRect);
                }
            }
        }
