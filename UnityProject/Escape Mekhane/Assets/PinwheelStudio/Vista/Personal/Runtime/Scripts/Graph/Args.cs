...
namespace Pinwheel.Vista.Graph
{
    ...
    public struct Args
    {
        ...
        /// <summary>Brush radius in world meters, stored in floatValue.</summary>
        public const int BRUSH_RADIUS = 8;
        /// <summary>Normalized brush softness, stored in floatValue.</summary>
        public const int BRUSH_SOFTNESS = 9;
        /// <summary>Normalized brush intensity, stored in floatValue.</summary>
        public const int BRUSH_INTENSITY = 10;
        /// <summary>Logical number of stroke points in the padded external position buffer, stored in intValue.</summary>
        public const int STROKE_POINT_COUNT = 11;
