...
namespace Pinwheel.Vista.Graph
{
    ...
    public class LPBInputProvider : IExternalInputProvider, ITerrainGraphArgumentsFiller//, ISerializationCallbackReceiver
    {
        ...
        public void SetInput(GraphInputContainer destInputContainer, GraphAsset executingGraph)
        {
            ...
            if (executingGraph is TerrainGraph terrainGraph && terrainGraph.HasSceneHeightInput())
            {
        ...
        /// </remarks>
        public void FillTerrainGraphArguments(TerrainDataGraph graph, IDictionary<int, Args> args)
        {
