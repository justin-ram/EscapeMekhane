...
namespace Pinwheel.Vista.Graph
{
    [NodeMetadata(
        title = "Angular Warp",
        path = "Adjustments/Angular Warp",
        icon = "",
        documentation = "",
        keywords = "",
        description = "Adding distortion to the image.\nThe direction mask will be map to [Min Angle, Max Angle] to define the warping direction.")]
    public class AngularWarpNode : ImageNodeBase
    {
        ...
        public float minAngle
        {
            ...
            set
            {
                m_minAngle = Mathf.Clamp(Mathf.Min(value, m_maxAngle), -360, 360);
            }
        }
        ...
        public float maxAngle
        {
            ...
            set
            {
                m_maxAngle = Mathf.Clamp(Mathf.Max(value, m_minAngle), -360, 360);
            }
        }
        ...
        public float directionMultiplier
        {
            ...
            set
            {
                m_directionMultiplier = Mathf.Clamp01(value);
            }
        }
        ...
        private static readonly string SHADER_NAME = "Hidden/Vista/Graph/AngularWarp";
        ...
        private static readonly int DIRECTION_MULTIPLIER = Shader.PropertyToID("_DirectionMultiplier");
        ...
        public override void ExecuteImmediate(GraphContext context)
        {
            ...
            m_material.SetFloat(DIRECTION_MULTIPLIER, m_directionMultiplier);
