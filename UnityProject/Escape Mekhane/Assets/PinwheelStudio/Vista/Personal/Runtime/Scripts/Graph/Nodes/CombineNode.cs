...
namespace Pinwheel.Vista.Graph
{
    ...
    public class CombineNode : ImageNodeBase, ISetupWithHint
    {
        ...
        public override void ExecuteImmediate(GraphContext context)
        {
            ...
            NodeLibraryUtilities.CombineNode.Execute(context, background, foreground, mask, (int)mode, targetRt, m_backgroundMultiplier, m_foregroundMultiplier, m_maskMultiplier);
