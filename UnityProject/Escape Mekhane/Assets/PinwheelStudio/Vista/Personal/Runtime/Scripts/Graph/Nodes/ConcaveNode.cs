...
namespace Pinwheel.Vista.Graph
{
    [NodeMetadata(
        title = "Concave",
        path = "Masking/Concave",
        icon = "",
        documentation = "",
        keywords = "",
        description = "Highlight the pixels that are lower than their neighbors.")]
    public class ConcaveNode : ImageNodeBase
    {
        ...
        private static readonly string SHADER_NAME = "Hidden/Vista/Graph/Concave";
