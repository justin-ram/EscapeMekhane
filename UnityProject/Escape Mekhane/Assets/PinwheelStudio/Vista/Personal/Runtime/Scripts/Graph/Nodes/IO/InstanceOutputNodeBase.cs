...
namespace Pinwheel.Vista.Graph
{
    public abstract class InstanceOutputNodeBase : ExecutableNodeBase, IOutputNode, IHasSeed
    {
        ...
        protected static readonly int BASE_INDEX = Shader.PropertyToID("_BaseIndex");
        protected static readonly int INSTANCE_COUNT = Shader.PropertyToID("_InstanceCount");

        protected static readonly int THREAD_PER_GROUP = 8;
        protected static readonly int MAX_THREAD_GROUP = 64000 / THREAD_PER_GROUP;
