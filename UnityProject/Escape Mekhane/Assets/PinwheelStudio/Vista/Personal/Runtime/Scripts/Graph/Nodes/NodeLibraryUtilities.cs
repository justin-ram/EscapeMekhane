    ...
    public static class NodeLibraryUtilities
    {
        public static class MathNode
        {
            ...
            public static void Invert(GraphContext context, RenderTexture targetRt)
            {
                ...
                context.RegisterDestroyLater(s_material);
        ...
        public static class ThinOutNode
        {
            public static void Execute(GraphContext context, ComputeBuffer inputPositionBuffer, Texture maskTexture, float maskMultiplier, int seed, ComputeBuffer outputPositionBuffer)
            {
                ...
                VistaLib.ThinOut(inputPositionBuffer, outputPositionBuffer, maskTexture, maskMultiplier, seed, baseSeed);
            }
        }
        public static class LevelsNode
        {
            ...
            public static void Execute(GraphContext context, Texture inputTexture, RenderTexture targetRt, float inLow, float inMid, float inHigh, float outLow, float outHigh)
            {
        ...
        public static class NoiseNode
        {
            ...
            public static void Execute(GraphContext context, RenderTexture targetRt, Params p)
            {
                ...
                context.RegisterDestroyLater(remapTex);
        ...
        public static class ClampNode
        {
            ...
            private static readonly int PASS = 0;
            public static void Execute(GraphContext context, Texture inputTexture, RenderTexture targetRt, float min, float max)
            {
                Material material = new Material(ShaderUtilities.Find(SHADER_NAME));
                context.RegisterDestroyLater(material);
                material.SetTexture(MAIN_TEX, inputTexture);
        ...
        public static class ConvexNode
        {
            ...
            private static readonly int PASS = 0;
            public static void Execute(GraphContext context, Texture inputTexture, RenderTexture targetRt, float epsilon, int tolerance)
            {
                Material material = new Material(ShaderUtilities.Find(SHADER_NAME));
                context.RegisterDestroyLater(material);
                material.SetTexture(MAIN_TEX, inputTexture);
        ...
        public static class DistanceFieldNode
        {
            ...
            public static void Execute(GraphContext context, Texture inputTexture, RenderTexture targetRt, int iterationCount)
            {
                ...
                context.RegisterUnloadLater(m_computeShader);
        ...
        public static class CombineNode
        {
            ...
            private static readonly int PASS = 0;
            public static void Execute(GraphContext context, Texture backgroundTexture, Texture foregroundTexture, Texture maskTexture, int mode, RenderTexture targetRt, float bgMul = 1, float fgMul = 1, float maskMul = 1)
            {
                Material material = new Material(ShaderUtilities.Find(SHADER_NAME));
                context.RegisterDestroyLater(material);
        ...
        public static class BlurNode
        {
            ...
            public static void Execute(GraphContext context, Texture inputTexture, RenderTexture targetRt, int radius)
            {
                Material material = new Material(ShaderUtilities.Find(SHADER_NAME));
                context.RegisterDestroyLater(material);
                material.SetTexture(MAIN_TEX, inputTexture);
