...
namespace Pinwheel.Vista.Graph
{
    [NodeMetadata(
        ...
        documentation = "",
        keywords = "",
        description = "Gradually shrink the mask. Useful when you want to include less regions in the mask.")]
    public class ShrinkNode : ImageNodeBase
    {
        ...
        private static readonly string COMPUTE_SHADER_NAME = "Vista/Shaders/Graph/Shrink";
