...
namespace Pinwheel.Vista.Graph
{
    ...
    public class SplatterNode : ImageNodeBase
    {
        ...
        public override void ExecuteImmediate(GraphContext context)
        {
            ...
            context.RegisterUnloadLater(m_quadGenShader);
            ...
            m_quadGenShader.SetInt(INSTANCE_COUNT, instanceCount);
            ...
            if (intensityTexture != null)
            {
                ...
                context.RegisterUnloadLater(m_maskSamplerShader);
                ...
                m_maskSamplerShader.SetInt(INSTANCE_COUNT, instanceCount);
