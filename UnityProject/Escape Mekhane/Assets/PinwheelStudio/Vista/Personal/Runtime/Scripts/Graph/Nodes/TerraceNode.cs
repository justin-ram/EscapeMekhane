...
namespace Pinwheel.Vista.Graph
{
    ...
    public class TerraceNode : ImageNodeBase
    {
        ...
        private static readonly int USE_HEIGHT_BLEND = Shader.PropertyToID("_UseHeightBlend");
        ...
        private static readonly int USE_SLOPE_BLEND = Shader.PropertyToID("_UseSlopeBlend");
        ...
        private static readonly int USE_MASK_BLEND = Shader.PropertyToID("_UseMaskBlend");
        ...
        {
            m_stepHeight = 5;
            m_remapCurve = AnimationCurve.EaseInOut(0, 0.35f, 1, 0.65f);
        ...
        public override void ExecuteImmediate(GraphContext context)
        {
            ...
            m_material.SetInteger(USE_HEIGHT_BLEND, m_useHeightMask ? 1 : 0);
            ...
            context.RegisterDestroyLater(heightBlendTexture);
            m_material.SetTexture(HEIGHT_BLEND_TEXTURE, heightBlendTexture);

            m_material.SetInteger(USE_SLOPE_BLEND, m_useSlopeMask ? 1 : 0);
            ...
            context.RegisterDestroyLater(slopeBlendTexture);
            m_material.SetTexture(SLOPE_BLEND_TEXTURE, slopeBlendTexture);

            m_material.SetInt(USE_MASK_BLEND, inputMaskTexture != null ? 1 : 0);
