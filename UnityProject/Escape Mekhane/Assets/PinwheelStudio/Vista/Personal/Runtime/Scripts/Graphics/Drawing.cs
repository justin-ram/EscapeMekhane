...
{
    /// <summary>
    /// Provides low-level quad and blit helpers used by Vista's runtime rendering path.
    /// </summary>
    public static class Drawing
    {
        ...
        /// <summary>
        /// Fullscreen unit quad in normalized 0..1 render-target space.
        /// </summary>
        ...
        /// <summary>
        /// Draws a quad into a render texture using a material pass and default 0..1 UVs.
        /// </summary>
        ...
        /// <summary>
        /// Draws a quad into a render texture using explicit quad corners and UVs.
        /// </summary>
        ...
        /// <summary>
        /// Draws a fullscreen unit quad into a render texture using a material pass.
        /// </summary>
        ...
        /// <summary>
        /// Draws a texture into a custom quad region of a render target using the standard blit shader.
        /// </summary>
        ...
        /// <summary>
        /// Draws a closed polygon outline into a render texture using line primitives.
        /// </summary>
        ...
        /// <summary>
        /// Copies a texture into a render target using the standard Vista blit shader.
        /// </summary>
        ...
        /// <summary>
        /// Copies a texture into a render target while remapping values into the 0..1 range expected by the shader.
        /// </summary>
        ...
        /// <summary>
        /// Copies only a UV sub-rectangle of a texture into a render target.
        /// </summary>
        ...
        /// <summary>
        /// Adds a texture into a render target using the additive pass of the standard blit shader.
        /// </summary>
        ...
        /// <summary>
        /// Keeps the greater value between a source texture and the current render-target value.
        /// </summary>
        public static void BlitMax(Texture from, RenderTexture to)
        {
            Material mat = new Material(ShaderUtilities.Find(BLIT_SHADER_NAME));
            mat.SetTexture(MAIN_TEX, from);
            DrawQuad(to, unitQuad, mat, 2);
            Object.DestroyImmediate(mat);
        }
    }
}
